...
exports.registerController = (req, res) => {
  const { firstName, lastName, email, password, dob, phone, gender, state, district, addressLine } = req.body;
  ...
  if (token) {
    jwt.verify(token, process.env.JWT_ACCOUNT_ACTIVATION, (err, decoded) => {
      if (err) {
        ...
        const { firstName,lastName, email, password, dob, phone, gender, state, district, addressLine } = jwt.decode(token);
